...
public abstract class TypedValueHolderSupportDialogFragment<E> extends DialogFragment {
    protected E mTypedValue;
    private long mTypedValueKey = -1;
    protected static final String TYPED_VALUE_KEY = TypedValueHolderSupportDialogFragment.class.getCanonicalName() + "typed_value_key";
    protected static final String TYPED_SAVE_VALUE_KEY = TypedValueHolderSupportDialogFragment.class.getCanonicalName() + "typed_save_value_key";
    ...
    public static <E> void putValue(TypedValueHolderSupportDialogFragment<E> pFragment, E pE) {
